...
class Fdhope(object):
    ...
    def generate_range_values(**kwargs):
        ...
        ranges_values = kwargs.get("ranges_values",[minValue] + sorted([np.random.uniform(minValue+0.2,maxValue) for _ in range(n_range-1)]) + [maxValue]) #Generate random ranges values
